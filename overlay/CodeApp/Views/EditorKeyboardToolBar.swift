        ...
        HStack(spacing: horizontalSizeClass == .compact ? 8 : 14) {
            Group {
                ...
                Button(
                    action: {
                        Task {
                            let value = await editorImplementation.getFullValue()
                            await MainActor.run {
                ...
                if isMonaco {
                    ...
                    if horizontalSizeClass != .compact {
                        Button(
                            action: {
                                Task { await editorImplementation.openSearchWidget() }
                            },
                            label: {
                        ...
                        Button(
                            action: {
                                Task { await editorImplementation._toggleGoToLineWidget() }
                            },
                            label: {
                        ...
                        Button(
                            action: {
                                Task { await editorImplementation._toggleCommandPalatte() }
                            },
                            label: {
